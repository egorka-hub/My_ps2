...
const POINTS = [
  ...
  {
    title: 'Храните полную историю работы с каждым клиентом',
    text: 'Изменение данных, общение по телефону, мессенджерам или email, работа с задачами и многое другое',
    isReverse: true,
    image: IMG_2,
  },
  ...
  },
  {
    ...
    text: 'Автоматически формируйте счета и договора с последующей отправкой их клиенту',
    isReverse: true,
    image: IMG_4,
  },
  {
    title: 'Работайте системно',
    text: 'Двигайте заявки и сделки по воронкам с обязательным чек-листом, постановкой задач',
    isReverse: false,
    image: IMG_5,
  },
];
